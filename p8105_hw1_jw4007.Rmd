...
hw1_df = tibble(
  ...
  character_vec = character(length = 10),
  factor_vec = factor(x = character_vec, levels = 3)
)
...
```{r hw1_df_convert, echo=TRUE, results='hide'}
mean_character = mean(pull(hw1_df, character_vec.as.numberic))
mean_factor = mean(pull(hw1_df, factor_vec.as.numberic))
